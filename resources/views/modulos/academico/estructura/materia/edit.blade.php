            ...
            <div class="grid-campos">
                ...
                <div class="campo">
                    ...
                    <select id="tipo" name="tipo" required>
                        <option value="normal"      {{ old('tipo', $materia->tipo) === 'normal'      ? 'selected' : '' }}>Normal</option>
                        <option value="observacion" {{ old('tipo', $materia->tipo) === 'observacion' ? 'selected' : '' }}>Especial (Observación)</option>
                    </select>
                ...
                <div class="campo campo-ancho">
                    ...
                    <textarea id="descripcion" name="descripcion"
                              rows="3"
                              maxlength="1000"
                              placeholder="Texto descriptivo que aparecerá en el boletín académico...">{{ old('descripcion', $materia->descripcion) }}</textarea>
